  ...
  if (!week) {
    return (
      <div className="min-h-screen flex items-center justify-center flex-col gap-4">
        ...
        <Link to="/theme1/art-picks" className="text-orange-500 underline">Back to Archive</Link>
      </div>
    );
  }

  return (
    <div className="bg-[#0b0b0f] text-zinc-100 min-h-screen pb-32">
      <div className="max-w-[1400px] mx-auto px-6 pt-16">
        {/* Header Section */}
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 mb-24">
          <div className="lg:col-span-8 space-y-8">
            <Link to="/theme1/art-picks" className="inline-flex items-center gap-2 text-zinc-500 hover:text-white transition-colors text-xs font-bold uppercase tracking-widest">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center gap-4">
                <span className="text-[10px] font-black uppercase tracking-widest text-orange-500">Curated by Banodoco Editorial</span>
                <span className="w-1 h-1 bg-zinc-800 rounded-full" />
                <span className="text-[10px] font-black uppercase tracking-widest text-zinc-500">Issue #{week.id.split('w')[1]}</span>
              </div>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-8">
          {week.videos.map((video, idx) => {
            // Vary the grid spanning for a more editorial look
            const span = idx === 0 ? 'lg:col-span-8 lg:row-span-2' : 
                         idx === 3 || idx === 7 ? 'lg:col-span-6' : 
                         'lg:col-span-4';
            ...
            return (
              <motion.div
                ...
                className={`${span} group relative aspect-video lg:aspect-auto overflow-hidden rounded-2xl bg-zinc-900 border border-zinc-800`}
              >
