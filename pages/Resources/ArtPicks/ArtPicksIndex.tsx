    ...
    <div className="bg-[#0b0b0f] text-zinc-100 min-h-screen pb-32">
      <div className="max-w-[1400px] mx-auto px-6 pt-16">
        <div className="mb-20 space-y-8 text-center max-w-3xl mx-auto">
          <Link to="/theme1" className="inline-flex items-center gap-2 text-zinc-500 hover:text-white transition-colors text-xs font-bold uppercase tracking-widest">
