...
export const ArtPicksSection: React.FC = () => {
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12">
      ...
      <div className="lg:col-span-7">
        <Link to={`/theme1/art-picks/${featuredWeek.id}`} className="block group relative aspect-[16/10] overflow-hidden rounded-3xl bg-zinc-900 border border-white/5">
      ...
      <div className="lg:col-span-5 flex flex-col justify-between">
        <div className="space-y-6">
          <div className="flex items-center justify-between border-b border-zinc-800 pb-4">
            ...
            <Link to="/theme1/art-picks" className="text-[10px] font-black tracking-widest uppercase text-white hover:text-orange-500 transition-colors">
              View All 104 Issues
            </Link>
          </div>
        ...
        <div className="mt-12 p-8 bg-zinc-900/50 rounded-3xl border border-zinc-800 border-dashed">
          ...
          <Link to="/theme1/art-picks" className="inline-flex items-center gap-2 text-sm font-bold border-b border-white pb-1 hover:text-orange-500 hover:border-orange-500 transition-all">
            Browse the Archive
